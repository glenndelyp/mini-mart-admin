// src/components/categories/CategoryDeleteModal.js
import { useState } from 'react'
import { AlertTriangle, X } from 'lucide-react'

export default function CategoryDeleteModal({ isOpen, category, onClose, onSuccess }) {
      ...
      <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl">
        <div className="flex items-center justify-between px-6 py-5 border-b border-slate-100">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-base font-bold text-slate-800">Delete Category</h2>
          </div>
        ...
        <div className="px-6 py-5">
          ...
          <p className="text-xs text-slate-400 mt-2">
            This may affect products assigned to this category. This action cannot be undone.
          </p>
        </div>
