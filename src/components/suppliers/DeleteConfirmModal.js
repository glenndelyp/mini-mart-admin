// src/components/suppliers/DeleteConfirmModal.js
import { AlertTriangle, X } from 'lucide-react'
import { useState } from 'react'

export default function DeleteConfirmModal({ isOpen, supplier, onClose, onSuccess }) {
      ...
      <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl">
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-slate-100">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-base font-bold text-slate-800">Delete Supplier</h2>
          </div>
        ...
        <div className="px-6 py-5">
          ...
          <p className="text-sm text-slate-600">
            ...
            <span className="font-semibold text-slate-800">{supplier.full_name}</span>{' '}
            from <span className="font-semibold text-slate-800">{supplier.company}</span>?
          </p>
